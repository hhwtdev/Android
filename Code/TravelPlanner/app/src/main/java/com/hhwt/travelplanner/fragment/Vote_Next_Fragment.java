...
import com.hhwt.travelplanner.activity.Explore_activities_Fragment;
...
public class Vote_Next_Fragment extends Fragment implements
    ...
    public static Vote_Next_Fragment newInstance(int pageNo) {

        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, pageNo);
        Vote_Next_Fragment fragment = new Vote_Next_Fragment();
