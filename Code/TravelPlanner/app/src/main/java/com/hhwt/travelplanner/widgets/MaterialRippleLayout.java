...
public class MaterialRippleLayout extends FrameLayout {
    ...
    public MaterialRippleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        rippleColors = a.getColor(R.styleable.MaterialRippleLayout_rippleColors, DEFAULT_COLOR);
    ...
    * Accessor
    ...
    public static class RippleBuilder {
        ...
        private int     rippleColors         = DEFAULT_COLOR;
        ...
        public RippleBuilder rippleColors(int color) {
            this.rippleColors = color;
            return this;
        }
        ...
        public MaterialRippleLayout create() {
            ...
            layout.setrippleColors(rippleColors);
