...
public class TypeFilterAdapter extends RecyclerView.Adapter<TypeFilterAdapter.ViewHolder> implements View.OnClickListener {
    public List<Starsfilter> ItemList = new ArrayList<>();
    public static List<Integer> ids = new ArrayList<>();
    private Context mContext;

    public TypeFilterAdapter(Context context, List<Starsfilter> feedItemList) {
