...
public class City_Guide_Fragment extends Fragment implements
...
//TextView labelheader;
   ...
   LinearLayout linearvalbottom;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CustomApplicationClass.getInstance().trackScreenView("Guides");
