...
public class Categorylistadapter extends RecyclerView.Adapter<Categorylistadapter.ViewHolder> implements View.OnClickListener {
    ...
    public Categorylistadapter(List<Categorylistmodel> items) {
        this.items = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_categorylist, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.thingstodofirstfloat.setText(item.getRating());
    ...
    protected static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            thingstodofirstfloat = (TextView) itemView.findViewById(R.id.thingstodofirstfloat);
